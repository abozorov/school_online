...
import (
	...
	"github.com/abozorov/school_online/cmd/raiting/internal/handler"
	"github.com/abozorov/school_online/cmd/raiting/internal/repo"
	"github.com/abozorov/school_online/cmd/raiting/internal/service"
...
func initServ(cfg *config.Config, l *logger.Logger, h *handler.Handler) *serv {
	...
	raitingv1.RegisterRaitingServiceServer(grpcServer.App, h)
